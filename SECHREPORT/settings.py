"""
Django settings for SECHREPORT project.
...
WSGI_APPLICATION = 'SECHREPORT.wsgi.application'
...
if DATABASE_URL:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "sechreport_db"),
...
STATICFILES_DIRS = [
    BASE_DIR / "StudentsDashboard/static",
